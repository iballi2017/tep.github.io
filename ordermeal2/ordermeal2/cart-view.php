...
<body>
    ...
    <div class="container">
       <div class="row">
           <div class="col-md-12">
                <div class="container cartView1Container">
                ...
                <div class="row itemContainer">
                       <div class="col-md-7 col-sm-7 col-sm-7 colum1">
                           <div class="row">
                               <div class="col-md-3 col-xs-5">
                                   <img src="photos/<?php echo $get_row['picture']; ?>" style="height: 90px; margin-top: 5px" alt="" class="img img-responsive">
                               </div>
                               <div class="col-md-8 col-xs-5">
                                    <h4 class="fooditem" style="position: absolute; margin-top: 30px"><?php echo $get_row['meal_name']; ?></h4>
                               </div>
                           </div>
                       </div>
                       <div class="col-md-5 col-sm-5 colum2">
                           <div class="row">
                               ...
                               <div class="col-md-6 col-xs-5">
                                    <div class="row">
                                        <div class="col-md-7">
                                                <h4>₦
                                                    <span id="subAmount"><?php echo number_format($sub, 2); ?></h4>
                                        </div>
                                        <div class="col-md-5">
                                            <h4 id="remove"><a href="cart-view.php?action=delete&id=<?php echo $get_row['meal_id']; ?>"><img src="photos/remove.svg" style="width: 25px;"></a></h4>
                                        </div>
                                    </div>
                               </div>
                           </div>
                   ...
                   <!-- //////////// -->
                     ...
                     <div class="row remove-cont">
                         ...
                         <div class="col-md-2 col-xs-7  col-xs-offset-1">
                        ...
                        <div class="form-inline">
                            ...
                            <div class="row remove-cont">
                                <div class="col-md-9">
                                    <input type="checkbox" name="saveloc" class="">
