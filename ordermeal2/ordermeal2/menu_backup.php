...
<div class="container">
        ...
        foreach($meal1 as $breaklunch) {
            ...
            <form method="post" action="menu.php?action=add&id=<?php echo $breaklunch['meal_id']; ?>">
                <div class="col-xs-12 col-sm-3 col-md-3 food-row-1">
                    <img src="photos/<?php echo $breaklunch['picture']; ?>" class="img img-responsive">
                    <p class="caption"><?php echo $breaklunch['name']; ?></p>
                    <p class="price">₦ <?php echo $breaklunch['price']; ?></p>

                    <input type="hidden" name="meal_quantity" value="1">
                    <input type="hidden" name="hidden_name" value="<?php echo $breaklunch['name']; ?>">
    ...
    <div class="row">
        ...
        foreach($meal as $sandwich) {
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 food-row-1">
                <img src="photos/<?php echo $sandwich['picture']; ?>" class="img img-responsive">
                <p class="caption"><?php echo $sandwich['name']; ?></p>
    ...
    <div class="row">
        ...
        foreach($meal as $swallow) {
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 food-row-1">
                <img src="photos/<?php echo $swallow['picture']; ?>" class="img img-responsive">
                <p class="caption"><?php echo $swallow['name']; ?></p>
